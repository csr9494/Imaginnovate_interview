...
import com.imaginnovate.demo.model.EmployeeTax;
...
public class EmployeeDetailsServiceImpl implements EmployeeDetailsService {
	...
	public EmployeeTaxIInfoDto taxdeductionForCurrentYear(Long id) {
		...
		Double tax = 0.0;
		Double cess = 0.0;
		EmployeeTax employeetaxInfo = new EmployeeTax();
		...
		EmployeeTaxIInfoDto employeeTaxDto = modelMapper.map(employeetaxInfo, EmployeeTaxIInfoDto.class);
